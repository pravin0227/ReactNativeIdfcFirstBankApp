...
const Transfer = ({route, navigation}) => {
    ...
    const [receiveraccouno, setreceiveraccouno] = useState("");
    ...
    const transferamount=()=>{
        ...
        axios.get("http://192.168.43.81:8082/transaction/transfer/"+amount+"/"+accountno+"/"+receiveraccouno)
         .then((response)=>{
         //
    ...
    return (
        ...
        <View style={{flex:1,backgroundColor:'#fff'}}>
           ...
           <View style={{backgroundColor:'#ded1d1',flex:0.3,borderBottomEndRadius:50,borderBottomStartRadius:50,paddingTop:50}}>
            ...
            <Text style={{fontWeight:'bold', fontSize:45, margin:49}}>Transfer</Text>
            </View>
            <View >
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            keyboardType="number-pad"
            require
            value={receiveraccouno}
            onChangeText={(receiveraccouno) => setreceiveraccouno(receiveraccouno)}
          />
        ...
        <TouchableOpacity style={styles.loginBtn} onPress={transferamount}>
