...
const Withdrawhistory = ({ route, navigation }) => {
    ...
    const depositmenu = () => {
        ...
        axios.get("http://192.168.43.81:8082/transaction/transfer/withdraw/" + accountno)
            .then((response) => {
                //
        ...
        <View style={{ flex: 1, backgroundColor: '#fff', justifyContent: 'flex-end' }}>
            ...
            <View style={{ backgroundColor: '#ded1d1', flex: 0.55, borderBottomEndRadius: 50, borderBottomStartRadius: 50, paddingTop: 50 }}>
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                    <Text style={{ fontWeight: 'bold', fontSize: 45, margin: 49 }}>Withdraw History</Text>
                </View>
