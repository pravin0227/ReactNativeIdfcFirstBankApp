...
const Transactions = ({route, navigation}) => {
  ...
  const withdraw =()=>{
    ...
    return (
        ...
        <TouchableOpacity style={styles.loginBtn} onPress={()=>navigation.navigate("deposithistory",{accountno})}>
                <Text style={{color:'white',fontWeight:'bold', fontSize:18, margin:2}}>Deposits</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.loginBtn} onPress={()=>navigation.navigate("Transferhistory",{accountno})} >
              {/* //onPress={transfer} */}
                <Text style={{color:'white',fontWeight:'bold', fontSize:18, margin:2}}>Transfers</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.loginBtn} onPress={()=>navigation.navigate("Withdrawhistory",{accountno})}>
