...
const Withdraw = ({route, navigation}) => {
    ...
    const withdraw=()=>{
        ...
        axios.get("http://192.168.43.81:8082/transaction/withdraw/"+amount+"/"+accountno)
         .then((response)=>{
         //
    ...
    return (
        ...
        <View style={{flex:1,backgroundColor:'#fff'}}>
            ...
            <View style={{backgroundColor:'#ded1d1',flex:0.47,borderBottomEndRadius:50,borderBottomStartRadius:50,paddingTop:50}}>
            <Image style={styles.image} source={require("../assets2/download.png")} />
            <View style={{justifyContent:'center',alignItems:'center'}}>
            <Text style={{fontWeight:'bold', fontSize:45, margin:49}}>Withdraw</Text>
            </View>
